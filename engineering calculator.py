...
def btneq_clicked(*args):
    try:
        ...
        tkinter.messagebox.showerror("Value Error", "Check your values and operators")
data = StringVar()
disp = Entry(root, font="Vazir 20", fg="black", bg="#abbab1", bd=0, justify=RIGHT, insertbackground="#abbab1", cursor="arrow")
...
pi_btn = Button(btnrow1, text="π", font="Vazir 18", relief=GROOVE, bd=0, command=pi_clicked, fg="white", bg="#333333")
...
btn1 = Button(btnrow1, text="1", font="Vazir 23", relief=GROOVE, bd=0, command=btn1_clicked, fg="white", bg="#333333")
