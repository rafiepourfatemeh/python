...
cur.execute(
    "create table if not exists roomd(rn number primary key,beds number,ac varchar(10),tv varchar(10),"
    "internet varchar(10),price number(10))")

cur.execute(
    "create table if not exists payments(id number primary key,dot varchar(15),time varchar(10),amt number,"
    "method varchar(10))")
cur.execute(
    "create table if not exists paymentsf(id number  primary key,f_name varchar,l_name varchar,c_number varchar,"
    "email varchar , r_n number ,day varchar,month varchar,year varchar,time varchar , method varchar,"
    "totalamt varchar)")
...
Label(sroot, text="سیستم مدیریت هتل", font='Bnazanin 60', bg='darkgray', fg='black').place(x=300, y=200)
...
def mainroot():
    ...
    root.title("سیستم مدیریت هتل")
    # ---seperator---
    sep = Frame(height=500, bd=1, relief='sunken', bg='white')
    # ---top frame---
    top_frame = Frame(root, height=70, width=1080, bg='darkgray')
    top_frame.place(x=0, y=0)
    tf_label = Label(top_frame, text='سیستم مدیریت هتل', font='msserif 33', fg='black', bg='darkgray', height=70)
    tf_label.pack(anchor='center')
    top_frame.pack_propagate(False)

    # --- DATE TIME ---
    def datetime():
        localtime = now.strftime("%Y-%-%dm %H:%M")
    ...
    def hotel_status():
        ...
        tr = Label(smf1, text='کل اتاقها', fg='white', bg='cyan4', width=100, height=2, font='helvetica 15')
        tr.pack(side='top')
        ...
        ar = Label(smf2, text='اتاقهای خالی', fg='white', bg='cyan4', width=130, height=2, font='helvetica 15')
        ar.pack(side='top')
        ...
        tre = Label(smf3, text='کل رزرو شده ها', fg='white', bg='cyan4', width=130, height=2, font='helvetica 15')
        tre.pack(side='top')
        ...
        tc = Label(smf4, text='کل مشتریان', fg='white', bg='cyan4', width=130, height=2, font='helvetica 15')
        tc.pack(side='top')
        ...
        ts = Label(smf5, text='کل کارمندان', fg='white', bg='cyan4', width=130, height=2, font='helvetica 15')
        ts.pack(side='top')
        ...
        ts = Label(smf6, text='درحال تعمیر', fg='white', bg='cyan4', width=130, height=2, font='helvetica 15')
        ts.pack(side='top')
        ...
        Label(b_frame, text='وضعیت هتل', font='msserif 12', bg='cyan4', fg='white').pack(anchor='center')
    ...
    def staff():
        ...
        Label(emp1inf, text="مدیرت", bg='white', font='msserif 17 bold').place(x=60, y=0)
        Label(emp1inf, text="آقای حسنی", bg='white', fg="Grey", font='msserif 10').place(x=60, y=37)
        Label(emp1inf, text="ساعت حضور 12:00 الی 15:00", bg='white', fg="Grey", font='msserif 10').place(x=60, y=59)
        Label(emp1inf, text="شماره تماس: 0215568877", bg='white', fg="Grey", font='msserif 10').place(x=60, y=83)
        ...
        Label(emp1inf, text="مسئول رزور", bg='white', font='msserif 17 bold').place(x=45, y=0)
        Label(emp1inf, text="خانم شهشهانی", bg='white', fg="Grey", font='msserif 10').place(x=45, y=37)
        Label(emp1inf, text="ساعت حضور 10:00 الی 21:00", bg='white', fg="Grey", font='msserif 10').place(x=45, y=59)
        Label(emp1inf, text="تماس : 02166998877", bg='white', fg="Grey", font='msserif 10').place(x=45, y=83)
        emp1inf.pack_propagate(False)
        ...
        emp1inf = Frame(b_frame, bg='White', height=112, width=320)
        Label(emp1inf, text="رستوران", bg='white', font='msserif 17 bold').place(x=72, y=0)  # pack(side='top')
        Label(emp1inf, text="آقای مظفری", bg='white', fg="Grey", font='msserif 10').place(x=72, y=37)
        Label(emp1inf, text="ساعت حضور: تایم ناهار و شام", bg='white', fg="Grey", font='msserif 10').place(x=72, y=59)
        Label(emp1inf, text="تماس : 02188447788", bg='white', fg="Grey", font='msserif 10').place(x=72, y=83)
        emp1inf.pack_propagate(False)
        ...
        Label(emp1inf, text="نظافت اتاق", bg='white', font='msserif 17 bold').place(x=55, y=0)  # pack(side='top')
        Label(emp1inf, text="خانم تقوی", bg='white', fg="Grey", font='msserif 10').place(x=55, y=37)
        Label(emp1inf, text="ساعت حضور 10:00 الی 21:00", bg='white', fg="Grey", font='msserif 10').place(x=55, y=59)
        Label(emp1inf, text="تماس : 092278965478", bg='white', fg="Grey", font='msserif 10').place(x=55, y=83)
        emp1inf.pack_propagate(False)
    ...
    def rooms():
        ...
        def roomdet(rno):
            Label(b_frame, text='اتاق %s' % rno, font='msserif 15', fg='white', bg='cyan4', width=10).place(x=535, y=0)
            ...
            tr = Label(smf1, text='تعداد تخت', fg='white', bg='cyan4', width=100, height=2, font='msserif 15')
            tr.pack(side='top')
            smf1.pack_propagate(False)
            ...
            tr = Label(smf2, text=' کولر', fg='white', bg='cyan4', width=100, height=2, font='msserif 15')
            tr.pack(side='top')
            smf2.pack_propagate(False)
            ...
            tr = Label(smf2, text='تلوزیون', fg='white', bg='cyan4', width=100, height=2, font='msserif 15')
            tr.pack(side='top')
            smf2.pack_propagate(False)
            ...
            tr = Label(smf2, text='وای فای', fg='white', bg='cyan4', width=100, height=2, font='msserif 15')
            tr.pack(side='top')
            smf2.pack_propagate(False)
            ...
            tr = Label(smf2, text=' قیمت', fg='white', bg='cyan4', width=100, height=2, font='msserif 15')
            tr.pack(side='top')
            smf2.pack_propagate(False)
            ...
            tr = Label(smf2, text='رزرو؟', fg='white', bg='cyan4', width=100, height=2, font='msserif 15')
            tr.pack(side='top')
            # print (rdata)
            smf2.pack_propagate(False)
        ...
        b1 = Button(b_frame, font='mssherif 10', text="اتاق 1", bg='white', fg='cyan4', width=10,
                    command=lambda: roomdet(1))
        b2 = Button(b_frame, font='mssherif 10', text="اتاق 2", bg='white', fg='cyan4', width=10,
                    command=lambda: roomdet(2))
        b3 = Button(b_frame, font='mssherif 10', text="اتاق 3", bg='white', fg='cyan4', width=10,
                    command=lambda: roomdet(3))
        b4 = Button(b_frame, font='mssherif 10', text="اتاق 4", bg='white', fg='cyan4', width=10,
                    command=lambda: roomdet(4))
        b5 = Button(b_frame, font='mssherif 10', text="اتاق 5", bg='white', fg='cyan4', width=10,
                    command=lambda: roomdet(5))
        b6 = Button(b_frame, font='mssherif 10', text="اتاق 6", bg='white', fg='cyan4', width=10,
                    command=lambda: roomdet(6))
        b7 = Button(b_frame, font='mssherif 10', text="اتاق 7", bg='white', fg='cyan4', width=10,
                    command=lambda: roomdet(7))
        b8 = Button(b_frame, font='mssherif 10', text="اتاق 8", bg='white', fg='cyan4', width=10,
                    command=lambda: roomdet(8))
        b9 = Button(b_frame, font='mssherif 10', text="اتاق 9", bg='white', fg='cyan4', width=10,
                    command=lambda: roomdet(9))
        b10 = Button(b_frame, font='mssherif 10', text="اتاق 10", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(10))
        b11 = Button(b_frame, font='mssherif 10', text="اتاق 11", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(11))
        b12 = Button(b_frame, font='mssherif 10', text="اتاق 12", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(12))
        b13 = Button(b_frame, font='mssherif 10', text="اتاق 13", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(13))
        b14 = Button(b_frame, font='mssherif 10', text="اتاق 14", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(14))
        b15 = Button(b_frame, font='mssherif 10', text="اتاق 15", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(15))
        b16 = Button(b_frame, font='mssherif 10', text="اتاق 16", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(16))
        b17 = Button(b_frame, font='mssherif 10', text="اتاق 17", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(17))
        b18 = Button(b_frame, font='mssherif 10', text="اتاق 18", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(18))
        b19 = Button(b_frame, font='mssherif 10', text="اتاق 19", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(19))
        b20 = Button(b_frame, font='mssherif 10', text="اتاق 20", bg='white', fg='cyan4', width=10,
    ...
    def payments():
        ...
        l = Label(b_frame, text='لطفا شناسه پرداخت را وارد کنید', font='msserif 15', bg='cyan4', fg='white')
        l.place(x=245, y=-5)
        b_frame.place(x=0, y=120 + 6 + 20 + 60 + 11)
        b_frame.pack_propagate(False)
        b_frame.tkraise()
        ...
        fl1.place(x=0, y=68)
        l1 = Label(fl1, text='تاریخ تراکنش', bg='cyan4', fg='white', font='msserif 17')
        l1.pack()
        ...
        l1 = Label(fl2, text='زمان تراکنش', bg='cyan4', fg='white', font='msserif 17')
        l1.pack()
        ...
        l1 = Label(fl3, text='مبلغ', bg='cyan4', fg='white', font='msserif 17')
        l1.pack()
        ...
        l1 = Label(fl4, text='مدل پرداخت', bg='cyan4', fg='white', font='msserif 17')
        l1.pack()
        ...
        def getid(event=None):
            ...
            fr1 = Frame(b_frame, height=38, width=1080 - 308, bg='white')
            fr1.place(x=0 + 308, y=68)
            l1 = Label(fl1, text='تارخ تراکنش', bg='cyan4', fg='white', font='msserif 17')
            # l1.pack()
            fr1.pack_propagate(False)
    ...
    def reserve():
        ...
        Label(b_frame, text='اطلاعات شخصی', font='msserif 15', bg='gray93').place(x=225, y=0)
        ...
        fnf.place(x=450, y=42)
        mnf.place(x=235, y=42)
        lnf.place(x=20, y=42)

        # --- Contact Information ---
        Label(b_frame, text='اطلاعات تماس', font='msserif 15', bg='gray93').place(x=225, y=90)
        ...
        cn.insert(0, 'شماره تماس *')
        em.insert(0, 'ایمیل *')
        ad.insert(0, "آدرس محل سکونت *")

        def on_entry_click4(event):
            if cn.get() == 'شماره تماس *':
                cn.delete(0, END)
                cn.insert(0, '')
        ...
        Label(b_frame, text='رزرو', font='msserif 15', bg='gray93').place(x=210, y=175)
        ...
        noc.insert(0, 'تعداد کودکان *')
        noa.insert(0, 'تعداد بزرگسالان *')
        nod.insert(0, 'تعداد روز *')

        def on_entry_click7(event):
            if noc.get() == 'تعداد کودکان *':
                noc.delete(0, END)
                noc.insert(0, '')

        def on_entry_click8(event):
            if noa.get() == 'تعداد بزرگسالان *':
                noa.delete(0, END)
                noa.insert(0, '')

        def on_entry_click9(event):
            if nod.get() == 'تعداد روز *':
                nod.delete(0, END)
                nod.insert(0, '')
        ...
        roomn = Entry(roomnf)
        roomn.insert(0, 'شماره اتاق را وارد کنید *')

        def on_entry_click10(event):
            if roomn.get() == 'شماره اتاق را وارد کنید *':
                roomn.delete(0, END)
                roomn.insert(0, '')
        ...
        def booking():
            if fn.get() == 'نام *' or ln.get() == 'کدملی *' or cn.get() == 'شماره تماس *' or em.get() == 'ایمیل' or ad.get() == "آدرس" or noc.get() == 'تعداد کودکان' or noa.get() == 'تعداد بزرگسالان' or nod.get() == 'تعداد روز' or roomn.get() == 'شماره اتاق را وارد کنید *':
                ...
                temp = cur.fetchone()
                if temp[0] == 'Reserved':
                    messagebox.showwarning('اتاق رزرو شده است', 'اتاق شماره ' + str(roomn.get()) + ' رزرو شده است')
                else:
                    # ___ PAYMENT ROOT ___
                    payroot = Tk()
                    payroot.title("پرداخت")
                    ...
                    Label(payroot, text='مدل پرداخت را انتخاب کنید ' + str(int(rp[0]) * int(nod.get())),
                          font='msserif 14 bold', bg='White').place(x=0, y=0)
                    Frame(payroot, height=4, width=300, bg='cyan4').place(x=0, y=39)
                    Radiobutton(payroot, text='نقد', bg='White', variable=pmethod, value=1, font='helvetica 15',
                                width=5).place(x=0, y=43 + 10)
                    Radiobutton(payroot, text='کارت', bg='White', variable=pmethod, value=2, font='helvetica 15',
                                width=5).place(x=0, y=80 + 10)
                    Radiobutton(payroot, text=' POS', bg='White', variable=pmethod, value=3, font='helvetica 15',
                                width=5).place(x=0, y=115 + 10)
                    Radiobutton(payroot, text='آنلاین', bg='White', variable=pmethod, value=4, font='helvetica 15',
                    ...
                    def f():
                        if pmethod != '':
                            ...
                            messagebox.showinfo("Successful", "اتاق با موفقیت رزرو شد ")
                            con.commit()
                            ...
                            messagebox.showwarning("انتخاب نشده", "لطفا مدل پرداخت خود را انتخاب کنید! ")
        ...
        def unreserve():
            if (roomn.get() == 'شماره اتاق را وارد کنید') or (roomn.get() == ''):
                messagebox.showerror('فیلد خالی', 'شماره اتاق را وارد کنید! ')
            else:
                cur.execute("update roomd set rstatus='Unreserved' where rn = ? ", (roomn.get(),))
                messagebox.showinfo("Successful", "اتاق از حالت رزرو خارج شد")
                reserve()
                con.commit()

        # ----------------right side------------------
        Label(b_frame, text='فیلتر', font='msserif 20', bg='gray93').place(x=850, y=0)
        ...
        Label(b_frame, text='تعداد اتاق', bg='gray93', font='17').place(x=730, y=50)
        nb = ttk.Combobox(b_frame, values=['انتخاب کنید...', '1', '2', '3'], state='readonly', width=22)
        nb.place(x=830, y=50)
        nb.current(0)

        Label(b_frame, text='کولر :', font='17', bg='gray93').place(x=732, y=75)
        ac = ttk.Combobox(b_frame, values=['انتخاب کنید...', 'Yes', 'No'], state='readonly', width=22)
        ac.place(x=830, y=75)
        ac.current(0)

        Label(b_frame, text='تلوزیون :', font='17', bg='gray93').place(x=732, y=100)
        tv = ttk.Combobox(b_frame, values=['انتخاب کنید...', 'Yes', 'No'], state='readonly', width=22)
        tv.place(x=830, y=100)
        tv.current(0)

        Label(b_frame, text='وای فای :', font='17', bg='gray93').place(x=732, y=125)
        wifi = ttk.Combobox(b_frame, values=['انتخاب کنید...', 'Yes', 'No'], state='readonly', width=22)
        wifi.place(x=830, y=125)
        wifi.current(0)

        listofrooms = Listbox(b_frame, height=6, width=36)
        listofrooms.place(x=735, y=190)
        listofrooms.insert(END, 'اتاقها اینجا نمایش داده می شود')
        listofrooms.insert(END, 'اول فیلترهای خود را انتخاب کنید')

        def findrooms():
            cur.execute(
                'select rn,price,rstatus from roomd where beds = ? and ac = ? and tv = ? and internet = ? order by '
                'price asc',
            ...
            if x == []:
                listofrooms.insert(END, 'اتاقی یافت نشد')
            for i in x:
                listofrooms.insert(END, 'شماره اتاق ' + str(i[0]) + ' - قیمت - ' + str(i[1]))

        Res = Button(b_frame, text='رزرو', bg='white', fg='cyan4', font='timenewroman 11', activebackground='green',
                     command=booking).place(x=235, y=270)
        unres = Button(b_frame, text='لغو رزرو', bg='white', fg='cyan4', font='timenewroman 11',
                       activebackground='green', command=unreserve).place(x=327, y=270)
        findrooms = Button(b_frame, text='جستجوی اتاق', bg='white', fg='cyan4', font='timenewroman 9',
    ...
    # -------------login module----------------------
    def login():
        q = messagebox.askyesno("خروج", "آیا میخواهید خارج شوید؟")
        if (q):
            root.destroy()
    ...
    Label(sl_frame, text='وضعیت هتل', font='msserif 13', bg='white').place(x=35, y=106)
    Label(sl_frame, text='اتاقها', font='msserif 13', bg='white').place(x=248, y=106)
    Label(sl_frame, text='رزرو', font='msserif 13', bg='white').place(x=417, y=106)
    Label(sl_frame, text='اطلاعات تماس', font='msserif 13', bg='white').place(x=774, y=106)
    Label(sl_frame, text='اطلاعات پرداخت', font='msserif 13', bg='white').place(x=570, y=106)
    Label(sl_frame, text='خروج', font='msserif 13', bg='white').place(x=968, y=106)
